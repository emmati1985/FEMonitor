sap.ui.define([
		...
		opaTest("MasterList Filtering on Importe less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("Importe").
				and.iSelectListItemInViewSettingsDialog("<100 Moneda").
		...
		opaTest("MasterList Filtering on Importe more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 Moneda").
				and.iPressOKInViewSelectionDialog();
