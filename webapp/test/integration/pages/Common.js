sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("femonitor/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("femonitor.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["femonitor/localService/mockserver"], function (mockserver) {
