sap.ui.define([
		...
		return BaseObject.extend("femonitor.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias femonitor.model.ListSelector
			 */
			 ...
			 * @return {femonitor.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
