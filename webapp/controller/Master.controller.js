	...
	return BaseController.extend("femonitor.controller.Master", {
		...
		onConfirmViewSettingsDialog: function(oEvent) {
			...
			aFilterItems.forEach(function(oItem) {
				switch (oItem.getKey()) {
					case "S1":
						aFilters.push(new Filter("argentina/Cae_status", FilterOperator.EQ, 'Procesado'));
						break;
					case "S2":
						aFilters.push(new Filter("argentina/Cae_status", FilterOperator.EQ, 'No Procesado'));
						break;
					case "S3":
						aFilters.push(new Filter("argentina/Cae_status", FilterOperator.EQ, 'Error' ));
						break;
					default:
						break;
				}
